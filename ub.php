...
$id=$_GET['id'];
include'conn.php';
$qw=mysqli_query($conn,"select * from book where id='$id'");
...
<div class="container">
    ...
    <form action="ub.php?id=<?php echo $id;  ?>" method="post" enctype="multipart/form-data">
    <div class="panel panel-success">
        <div class="panel-heading">
            <h2 class="text-center" style="font-weight: bold;font-family: cursive;"><i class="fa fa-book"></i>edit Book </h2>
        </div>
        <div class="panel-body">
            <input type="text" name="name" value="<?php  echo $tt['name']; ?>" class="form-control"><br>
            <input type="email" name="description" value="<?php  echo $tt['description']; ?>" class="form-control"><br>
          

             <input type="text" value="<?php  echo $tt['auther']; ?>" name="auther" class="form-control"><br>

                select book image
             <input type="file" name="img" style="color: green;font-size: 16px;" ><br>
             <hr style="background-color: green;color: green">

                 select book file
             <input type="file" name="book" style="color: green;font-size: 16px;">
               <hr style="background-color: green;color: green">
...
<button type="submit" name="log" class="btn btn-success btn-lg">Edit Book </button>
 ...
 $name=isset($_POST['name'])?$_POST['name']:'';
   ...
   $auther=isset($_POST['auther'])?$_POST['auther']:'';
    ...
    if(isset($_POST['log']))
    {
     ...
     $res=mysqli_query($conn,"update book set name='$name',description='$desc',image='$i',auther='$auther',path='$bookname' where id='$id' 
       ");
   if(isset($res))
   {
            echo'<script>alert("edit book successfully ");</script>';
