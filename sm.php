...
mysqli_query($conn,"delete from user where id='$id'");
 echo'<meta http-equiv="refresh" content="0 ; url=tm.php">';
}
...
<body>
        ...
        <div class="table-responsive">
            <div >
                <table class="table table-hover">
                    ...
                    $res=mysqli_query($conn,"select * from user where type=2");
 ...
 <td>
 <a href="sm.php?id='.$row['id'].'" class="btn btn-danger btn-block">Delete</a>
 </td>

<td><a href="us.php?id='.$row['id'].'" class="btn btn-success btn-block">Update</a></td>
                                </tr>
