...
mysqli_query($conn,"delete from course where id='$id'");
 echo'<meta http-equiv="refresh" content="0 ; url=cm.php">';
}
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li><a href="bm.php">book Manage</a></li>
                                ...
                                <td>'.$row['id'].'</td>
                                 <td>'.$row['name'].'</td>
                                  <td>'.$row['description'].'</td>
                                   <td>
                                   <img src="img/'.$row['image'].'" width="130px" height="130px" />
                                   </td>

                                    <td>'.$row['price'].'</td>

 <td><a href="cm.php?id='.$row['id'].'" class="btn btn-danger btn-block">Delete</a></td>

<td><a href="uc.php?id='.$row['id'].'" class="btn btn-success btn-block">Update</a></td>
                                </tr>
