...
$id=$_GET['id'];
include'conn.php';
$qw=mysqli_query($conn,"select * from course where id='$id'");
...
<div class="container">
    ...
    <form action="uc.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
    <div class="panel panel-success">
        ...
        <div class="panel-body">
            ...
            <input type="text" name="description" value="<?php echo $tt['description']; ?>"  class="form-control"><br>
            select course image
             <input type="file" name="img" ><br> 

             <input type="number" value="<?php  echo $tt['price']; ?>" name="price" class="form-control"><br>
...
<div class="col-xs-5"></div>
 ...
 $name=isset($_POST['name'])?$_POST['name']:'';
   ...
   $price=isset($_POST['price'])?$_POST['price']:'';
    ...
    $res=mysqli_query($conn,"update course set name='$name' , description='$desc', image='$i',price='$price',
tname='$tname', tid='$id1' where id='$id'
       ");
   if(isset($res))
   {
            echo'<script>alert("edit course successfully ");</script>';
