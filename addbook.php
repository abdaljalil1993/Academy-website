...
<div class="container">
    ...
    <div class="panel panel-success">
        <div class="panel-heading">
            <h2 class="text-center" style="font-weight: bold;font-family: cursive;"><i class="fa fa-book"></i>Add Book </h2>
        </div>
        <div class="panel-body">
            <input type="text" name="name" placeholder="Book name" class="form-control"><br>
            <input type="email" name="description" placeholder="Book description" class="form-control"><br>
          

             <input type="text" placeholder="Auther name" name="auther" class="form-control"><br>
...
<button type="submit" name="log" class="btn btn-success btn-lg">Add Book </button>
 ...
 $name=isset($_POST['name'])?$_POST['name']:'';
   ...
   $auther=isset($_POST['auther'])?$_POST['auther']:'';
    ...
    $res=mysqli_query($conn,"insert into book(name,description,auther,image,path) 
        values('$name','$desc','$auther','$i','$bookname')");
   if(isset($res))
   {
